...
// 1. Use destructuring to assign appropriate variables based on the sounds animals make.
  const sounds (moo, neigh, baa, oink, cluck )=["cow","horse","sheep", "pig", "chicken"];
...
// 3. Little the chicken had to go back to the coop, so now we're left with three. Let's use color variables of blackAndWhite, black, and pink.
  const color {blackAndWhite,black,pink} = {blackAndWhite:"cow", black:"sheep", pink:"pig"};
// Arrays
...
const {songs: {song2, song4}, kermit: {job: nestedJob, partner: nestedPartner}} = {songs:{song2:"Moving Right Along",song4:"I Hope That Something Better Comes Along"},kermit:{job:"Host of The Muppet Show",partner:"Miss Piggy"}};
